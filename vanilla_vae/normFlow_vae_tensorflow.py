...
for it in range(500000):
    ...
    if ((Y_mb[0,0]) == 1):
        ...
        distribution[1].append(sess.run(z_sample,feed_dict={X: X_mb}).tolist())
    elif ((Y_mb[0,2]) == 1):
        distribution[2].append(sess.run(z_sample,feed_dict={X: X_mb}).tolist())
    elif ((Y_mb[0,3]) == 1):
        distribution[3].append(sess.run(z_sample,feed_dict={X: X_mb}).tolist())
    elif ((Y_mb[0,4]) == 1):
        distribution[4].append(sess.run(z_sample,feed_dict={X: X_mb}).tolist())
    elif ((Y_mb[0,5]) == 1):
        distribution[5].append(sess.run(z_sample,feed_dict={X: X_mb}).tolist())
    elif ((Y_mb[0,6]) == 1):
        distribution[6].append(sess.run(z_sample,feed_dict={X: X_mb}).tolist())
    elif ((Y_mb[0,7]) == 1):
        distribution[7].append(sess.run(z_sample,feed_dict={X: X_mb}).tolist())
    elif ((Y_mb[0,8]) == 1):
